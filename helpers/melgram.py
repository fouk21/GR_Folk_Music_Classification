...
class Melgram():
    def __init__(self, __audio_files) -> None:
        ...
        self.output_path = f'{CURRENT_DIR}/../data/mel-spectrograms'
    ...
    def extract_mel_spectrograms(self, region):
        i = 1
        ...
        for audio_file in self.audio_files:
            ...
            print(f'Creating mel-spectrogram for {region}: {i:03} out of {total}')
            i += 1
