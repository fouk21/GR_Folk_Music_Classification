...
def main():
    ...
    data, labels, num_classes, class_mapping = DataUtils.preprocess_feature_data(args.dataset_location)
    ...
    model_experiment.model_summary('features_rnn_model_summary', results_dir)
